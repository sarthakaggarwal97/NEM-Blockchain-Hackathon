...
public class Ed25519GroupElement implements Serializable {
	 ...
	 */
	public static Ed25519GroupElement p3( // ok
			final Ed25519FieldElement X,
			final Ed25519FieldElement Y,
			final Ed25519FieldElement Z,
	 ...
	 */
	public static Ed25519GroupElement p1xp1( // ok
			final Ed25519FieldElement X,
			final Ed25519FieldElement Y,
			final Ed25519FieldElement Z,
			final Ed25519FieldElement T) {
	 ...
	 */
	public static Ed25519GroupElement precomputed( // ok
	 ...
	 */
	public Ed25519GroupElement toP2() { // ok
	 ...
	 */
	public Ed25519GroupElement toP3() { // ok
	 ...
	 */
	public void precomputeForScalarMultiplication() { // ok
	 ...
	 */
	public Ed25519GroupElement dbl() { // ok
		switch (this.coordinateSystem) {
			case P2:
			case P3:
	 ...
	 */
	private Ed25519GroupElement precomputedAdd(final Ed25519GroupElement g) { // ok
	 ...
	 * @return The result in the P x P coordinate system.
	 */
	public Ed25519GroupElement add(final Ed25519GroupElement g) { // ok
		if (this.coordinateSystem != CoordinateSystem.P3) {
			throw new UnsupportedOperationException();
		}
	 ...
	 */
	private Ed25519GroupElement cmov(final Ed25519GroupElement u, final int b) { // ok
	 ...
	 */
	private Ed25519GroupElement select(final int pos, final int b) { // ok
		// Is r_i negative?
	 ...
	 */
	public Ed25519GroupElement scalarMultiply(final Ed25519EncodedFieldElement a) { // ok
	...
	public String toString() {
		return String.format(
				...
				this.Y.toString(),
				this.Z.toString(),
				this.T != null ? this.T.toString() : "null");
	}
}
